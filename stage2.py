...
def compute_heart_rates(displacement, tfm_ecg2, t_radar, fs_radar, t_ecg, fs_ecg):
    ...
    if method == 'heart_sound_method':
        ...
        heart_rates_fil1, heart_rates_fil2, peaks_radar, detection_signal = heart_sound_method(displacement, t_radar,
                                                                                               fs_radar, True)
        ...
        plt.figure()
        plt.plot(t_radar[np.logical_and(t_radar > t_radar[peaks_radar[1]], t_radar < t_radar[peaks_radar[-1]])][1::200],
                 heart_rates_fil1, label='ARMA + lowpass')
        plt.plot(t_radar[np.logical_and(t_radar > t_radar[peaks_radar[1]], t_radar < t_radar[peaks_radar[-1]])][1::200],
                 heart_rates_fil2, label='ARMA + median')
        ...
        # peaks_final = peaks_radar
        # heart_rates_comb = heart_rates
